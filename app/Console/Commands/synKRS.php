...
class synKRS extends Command
{
    ...
    {
        $accessToken = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJjaWQiOiJ1bnBhcyIsImlhdCI6MTc1MTYwMjIzMiwiZXhwIjoxNzUxNjA1ODMyfQ.onZbvPf_HZcBWkqVlZQG0i7FZITDJsL7uHWrnq2zdTk";
        $limit = 1000;
