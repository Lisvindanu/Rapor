...
class synKRS extends Command
{
    ...
    {
        $accessToken = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJjaWQiOiJ1bnBhcyIsImlhdCI6MTc1MzA3MDI2NiwiZXhwIjoxNzUzMDczODY2fQ.LDJQQnj0uDfuXrB3ELuEvuv38bMMrk1CMhgesIW1Io8";
        $limit = 1000;
