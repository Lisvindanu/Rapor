...
class KeuanganMataAnggaranSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Data mata anggaran lengkap sesuai dengan list yang diberikan
        $mataAnggaranData = [
            // I. IMPLEMENTASI VISI DAN MISI
            [
                'kode' => 'I', 'nama' => 'IMPLEMENTASI VISI DAN MISI', 'kategori' => 'debet',
                'children' => [
                    ['kode' => '1.2', 'nama' => 'Pendanaan Kegiatan (Diskusi, Seminar Ke-Islaman dan Ke-Sundaari, SPJ dll.)', 'kategori' => 'debet'],
            ...
            [
                ...
                'children' => [
                    ...
                    ['kode' => '2.8', 'nama' => 'Monitoring dan dan Evaluasi Pendidikan dan Pengajaran', 'kategori' => 'debet'],
                ]
            ],
            // III. PENELITIAN
            [
