...
<html lang="en">
  <head>
    ...
    <style>
        body {
            font-family: 'Poppins', sans-serif; /* Mengatur font-family menjadi Poppins */
        ...
        .box {
            ...
            border-radius: 10px; /* border radius untuk membuat sudut melengkung */
            padding: 10px; /* menambahkan padding agar card tidak terlalu dekat dengan border */
        }
        ...
        .card {
            ...
            margin: 10px auto; /* untuk membuat card berada di tengah halaman */
            border: 0px solid rgba(0, 0, 0, 0.2); /* border dengan warna transparan */
            border-radius: 10px; /* border radius untuk membuat sudut melengkung */
        }
        ...
        .card-header {
            ...
            color: white;
            background-color: rgba(0, 0, 139, 0.55); /* background dengan transparansi */
            background-image: url('{{ asset('storage/images/bg-pattern.png') }}'); /* URL gambar latar belakang */
            background-repeat: repeat; /* Gambar latar belakang diulang */
            line-height: 0.5;
        }

        .logo {
            width: 100px; /* Memastikan lebar logo maksimal */
            height: auto; /* Menyesuaikan tinggi logo secara otomatis */
            margin: 10px auto; /* Memberikan jarak kanan antara logo dan teks */
        }
        ...
        .modul {
            ...
            border-radius: 5px;
            transition: background-color 0.3s ease, transform 0.3s ease; /* Efek transisi pada perubahan warna latar belakang dan skala */
        }

        .modul:hover {
            transform: scale(1.05); /* Memperbesar modul saat menghover */
        }

        .modul img {
            max-width: 100%; /* Membuat gambar agar tidak melebihi lebar modul */
        }

        .modul:hover {
            background-color: #e0e0e0; /* Warna latar belakang yang berbeda saat mouse dihover */
        }
        ...
        .role {
            ...
            background-color: white;
            border-radius: 5px;
            transition: background-color 0.1s ease, color 0.1s ease; /* Efek transisi pada perubahan warna latar belakang dan warna teks */
        }

        .role:hover {
           background-color: rgba(0, 0, 139, 0.55); /* Warna latar belakang biru saat mouse dihover */
           color: #ffffff; /* Warna teks putih saat mouse dihover */
        }

        .role p {
            color: rgba(0, 0, 139, 0.55);; /* Warna biru untuk teks paragraf */
        }

        .role span {
            color: rgba(101, 101, 101, 0.55);; /* Warna biru untuk teks paragraf */
        }

        .role:hover p {
            color: #ffffff; /* Warna putih untuk teks paragraf saat dihover */
        }
                    ...
                    <div class="card-header">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <img src="{{ asset('storage/images/unpas-logo.png') }}" alt="Logo UNPAS" class="logo">
                                </div>
                            </div>
                        </div>
                    </div>
