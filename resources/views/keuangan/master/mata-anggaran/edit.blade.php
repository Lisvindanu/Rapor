{{-- F:\rapor-dosen\resources\views\keuangan\master\mata-anggaran\edit.blade.php --}}
@extends('keuangan.master.layouts.master-edit')

@php
    $headerConfig = [
        'title' => 'Edit Mata Anggaran',
        'description' => 'Mengubah data mata anggaran: ' . $mataAnggaran->nama_mata_anggaran,
        'back_route' => route('keuangan.mata-anggaran.index'),
        'back_text' => 'Kembali ke Daftar'
    ];

    $formConfig = [
        'title' => 'Form Edit Mata Anggaran',
        'action' => route('keuangan.mata-anggaran.update', $mataAnggaran->id),
