{{-- F:\rapor-dosen\resources\views\keuangan\master\sub-mata-anggaran\edit.blade.php --}}
@extends('keuangan.master.layouts.master-edit')

@php
    $headerConfig = [
        'title' => 'Edit Sub Mata Anggaran',
        'description' => 'Mengubah data sub mata anggaran: ' . $subMataAnggaran->nama_mata_anggaran,
        'back_route' => route('keuangan.sub-mata-anggaran.index', $parent->id),
        'back_text' => 'Kembali ke Daftar Sub'
    ];

    $formConfig = [
        'title' => 'Form Edit Sub Mata Anggaran',
        'action' => route('keuangan.sub-mata-anggaran.update', [$parent->id, $subMataAnggaran->id]),
        'cancel_route' => route('keuangan.sub-mata-anggaran.index', $parent->id),
        'data' => $subMataAnggaran,
        'fields' => [
            [
