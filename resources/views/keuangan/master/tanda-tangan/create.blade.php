{{-- resources/views/keuangan/master/tanda-tangan/create.blade.php --}}
@extends('keuangan.master.layouts.master-create')

@php
    $headerConfig = [
        'title' => 'Tambah Penanda Tangan',
        'description' => 'Menambahkan data penanda tangan baru',
        'back_route' => route('keuangan.tanda-tangan.index'),
        'back_text' => 'Kembali ke Daftar'
    ];

    $formConfig = [
        'title' => 'Form Tambah Penanda Tangan',
        'action' => route('keuangan.tanda-tangan.store'),
        ...
        'fields' => [
            ...
            [
                ...
                'required' => false,
                'col_size' => '12',
                'help_text' => 'Gambar tanda tangan dalam format digital'
            ]
        ]
    ];
@endphp
