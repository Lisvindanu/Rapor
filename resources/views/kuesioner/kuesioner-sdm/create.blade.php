                ...
                <div class="col-8">
                    <div class="card">
                        ...
                        <div class="card-body" style="">
                            <form action="{{ route('kuesioner.kuesioner-sdm.store') }}" method="POST" id="form-soal">
                                @csrf
                                <!-- Nama Indikator -->
                                        ...
                                        <select id="periode-dropdown" class="form-select"
                                            ...
                                            @foreach ($daftar_periode as $periode)
                                                <option value="{{ $periode->kode_periode }}"
                                                    {{ isset($kuesioner) && $kuesioner->periode_rapor == $periode->kode_periode ? 'selected' : '' }}>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="hidden" id="nip" name="nip"
                                            value="{{ isset($kuesioner) ? $kuesioner->nip : '' }}">
                                    </div>
                                </div>
                                <!-- Soal Acak -->
                                <div class="form-group row">
