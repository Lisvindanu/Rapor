...
@section('konten')
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card border-success">
                            <div class="card-body text-center">
                                ...
                                <a href="{{ route('whistleblower.admin.laporan') }}" class="btn btn-success">Lihat
                                    Laporan</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 mb-3">
                        <div class="card border-primary">
                            <div class="card-body text-center">
                                ...
                                <a href="{{ route('whistleblower.admin.kategori.index') }}"
                                    class="btn btn-primary">Kelola</a>
                            </div>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            @else
                                                                ...
                                                                <br><small
                                                                    class="text-muted">{{ $item->email_pelapor }}</small>
                                                            @endif
                                                        </td>
                                                        <td>
                                                                    ...
                                                                    <div class="btn-group btn-group-sm">
                                                                        ...
                                                                        <ul class="dropdown-menu">
                                                                            ...
                                                                            <li><a class="dropdown-item" href="#"
                                                                                    ...
                                                                                    <i
                                                                                        class="fas fa-exclamation text-warning"></i>
                                                                                    Butuh Bukti
                                                                                </a></li>
                                                                            <li><a class="dropdown-item" href="#"
    ...
    <!-- Modal Update Status -->
    <div class="modal fade" id="modalUpdateStatus" tabindex="-1" aria-labelledby="modalUpdateStatusLabel"
        aria-hidden="true">
                ...
                <form id="formUpdateStatus" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="keterangan_admin" name="keterangan_admin" rows="3"
